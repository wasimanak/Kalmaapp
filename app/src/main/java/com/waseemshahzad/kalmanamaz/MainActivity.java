...
import com.waseemshahzad.kalmanamaz.model.ContactsModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_kalma=findViewById(R.id.btn_kalma);
        ...
        btn_kalma.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this,Kalma.class));
            }
        });
...
//                intent.putExtra(Intent.EXTRA_SUBJECT, "KSK User");
    ...
    public class TaskContact extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Kalma_Contacts");
